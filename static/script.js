// Wait for full page load before wiring anything
window.addEventListener("load", function () {
  ...
  async function sendMsg() {
    ...
    try {
      ...
      if (!reply) {
        addMessage("bot", "⚠️ Empty response. Please try again.");
      } else {
      ...
      if (err.name === "AbortError") {
        addMessage("bot", "⏱️ Took too long. Please try again.");
      } else if (!navigator.onLine) {
        addMessage("bot", "📡 You are offline. Check your connection.");
      } else {
